...
- Explains only minimum rules.
- Notices Zhou Ping's limited account-number ability.
- Adds an unexplained small note beside Zhou Ping's name.
- Does not explain the meaning of the removed three-mark token or the register note.
...
- What exactly happens to probationers whose three-mark tokens are removed?
- What does Zhao Steward's extra register note mean?
- How much can Zhou Ping use limited literacy and account-number awareness?
- What will East Shed life and first work assignment look like?
- How scarce and useful is the daily qi-guiding lesson?

## Must Inherit Next Chapter

- Chapter 2 must follow the golden-three design: Bad Work Becomes an Entrance.
- Chapter 2 should not become ordinary servant-life description.
- Chapter 2 should show that work assignment affects cultivation access.
- Zhou Ping should actively choose an unwanted task to create a crack.
- The choice must carry visible cost and visible return.
