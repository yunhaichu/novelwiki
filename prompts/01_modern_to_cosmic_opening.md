...
Chapter one must not explain the universe.

Chapter one should make the reader feel:
...
- `prompts/00_cosmic_civilization_arena.md` output;
...
## 1. Modern Ordinary Scene

Location:
-

Modern task / pressure:
-

What makes it familiar to Chinese webnovel readers:
-

What the protagonist wants right now:
-

What failure costs immediately:
-

## 2. First Abnormal Crack

What small abnormal signal appears:
-

Why ordinary people would ignore or misread it:
-

Why protagonist notices it:
-
...
- Earth is being observed;
- Earth has a civilization rating;
- multiple high civilizations exist;
- Earth may be annexed, protected, or exploited;
- protagonist may be a special sample;
- high civilization technology is not pure fantasy;
- cosmic war is happening elsewhere.
...
Protagonist's new immediate problem:
-
